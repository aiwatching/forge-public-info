...
#
# Re-installing afterwards: just run install-portal.sh again.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/aiwatching/forge-public-info/main/uninstall-portal.sh | bash
#   curl -fsSL ...uninstall-portal.sh | bash -s -- --yes        # skip the prompt
#
# This file is ASCII-only on purpose (see install-portal.sh header).
...
$(c_grn 'OK') Forge Personal uninstalled.
  ...
  Re-install anytime by running install-portal.sh again.
EOF
